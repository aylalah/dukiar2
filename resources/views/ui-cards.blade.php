...
@section('content')
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="card m-b-30">
                            <img class="card-img-top img-fluid" src="{{url('/')}}/assets/images/small/img-1.jpg" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="card m-b-30">
                            <img class="card-img-top img-fluid" src="{{url('/')}}/assets/images/small/img-2.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h4 class="card-title font-20 mt-0">Card title</h4>
                                <p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="card m-b-30">
                            <img class="card-img-top img-fluid" src="{{url('/')}}/assets/images/small/img-3.jpg" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="card m-b-30">
                            ...
                            <img class="img-fluid" src="{{url('/')}}/assets/images/small/img-4.jpg" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>
                                <a href="#" class="card-link">Card link</a>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <img class="card-img-top img-fluid" src="{{url('/')}}/assets/images/small/img-5.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h4 class="card-title font-20 mt-0">Card title</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            ...
                            <img class="card-img-bottom img-fluid" src="{{url('/')}}/assets/images/small/img-7.jpg" alt="Card image cap">
                        </div>
                    </div>

                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <img class="card-img img-fluid" src="{{url('/')}}/assets/images/small/img-6.jpg" alt="Card image">
                ...
                <div class="row m-b-30">
                    <div class="col-12">
                        ...
                        <div class="card-deck-wrapper">
                            <div class="card-deck">
                                <div class="card m-b-30">
                                    <img class="card-img-top img-fluid" src="{{url('/')}}/assets/images/small/img-4.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title font-20 mt-0">Card title</h4>
                                ...
                                <div class="card m-b-30">
                                    <img class="card-img-top img-fluid" src="{{url('/')}}/assets/images/small/img-6.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title font-20 mt-0">Card title</h4>
