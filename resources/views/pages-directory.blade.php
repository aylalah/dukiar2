                            ...
                            <div>
                                <div class="directory-bg text-center">
                                    <div class="directory-overlay">
                                        <img class="rounded-circle thumb-lg img-thumbnail" src="{{url('/')}}/assets/images/users/user-2.jpg" alt="Generic placeholder image">
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card m-b-20">
                            <div>
                                <div class="directory-bg text-center">
                                    <div class="directory-overlay">
                                        <img class="rounded-circle thumb-lg img-thumbnail" src="{{url('/')}}/assets/images/users/user-3.jpg" alt="Generic placeholder image">
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card m-b-20">
                            <div>
                                <div class="directory-bg text-center">
                                    <div class="directory-overlay">
                                        <img class="rounded-circle thumb-lg img-thumbnail" src="{{url('/')}}/assets/images/users/user-4.jpg" alt="Generic placeholder image">
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                            <div class="card directory-card m-b-20">
                                <div>
                                    <div class="directory-bg text-center">
                                        <div class="directory-overlay">
                                            <img class="rounded-circle thumb-lg img-thumbnail" src="{{url('/')}}/assets/images/users/user-5.jpg" alt="Generic placeholder image">
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card directory-card m-b-20">
                                <div>
                                    ...
                                    <div class="directory-bg text-center">
                                        <div class="directory-overlay">
                                            <img class="rounded-circle thumb-lg img-thumbnail" src="{{url('/')}}/assets/images/users/user-6.jpg" alt="Generic placeholder image">
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card directory-card m-b-20">
                                <div>
                                    <div class="directory-bg text-center">
                                        <div class="directory-overlay"> 
                                            <img class="img-thumbnail rounded-circle thumb-lg" src="{{url('/')}}/assets/images/users/user-7.jpg" alt="Generic placeholder image">
                                        </div>
                                    </div>
